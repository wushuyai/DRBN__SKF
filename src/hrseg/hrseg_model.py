...
# import sys
# sys.path.append('/path/to/project_root')  # 替换为你的实际项目根目录路径


from src.hrseg.hrseg_lib.models import seg_hrnet

import numpy as np
import torch
import torch.nn.functional as F
from PIL import Image
from src.hrseg.hrseg_lib.config import config
from src.hrseg.hrseg_lib.config import update_config
# from src.hrseg.hrseg_lib.datasets.cityscapes import (Cityscapes)
from src.hrseg.hrseg_lib.datasets.pascal_ctx import PASCALContext
...
def create_hrnet():
    ...
    args['cfg'] = r'D:\code\python\DRBN_SKF\src\hrseg\hrseg_lib\pascal_ctx\seg_hrnet_w48_cls59_480x480_sgd_lr4e-3_wd1e-4_bs_16_epoch200.yaml'
    args['opt'] = []
    ...
    pretrained_dict = torch.load(r'D:\code\python\DRBN_SKF\src\hrseg\hrnet_w48_pascal_context_cls59_480x480.pth')
